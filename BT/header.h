...
thread_local static double cuf[PROBLEM_SIZE];
thread_local static double q[PROBLEM_SIZE];
thread_local static double ue[PROBLEM_SIZE][5];
thread_local static double buf[PROBLEM_SIZE][5];
